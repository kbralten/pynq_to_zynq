...
2.  **Locate the Modules Archive (Conditional):**
    If your kernel configuration uses loadable modules (which is standard), PetaLinux creates a tarball for them.
...
3.  **Inject Modules into Debian:**
    *Only if you found the modules file in the previous step.*
